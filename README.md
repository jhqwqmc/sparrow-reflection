...
// Introduce these static methods for conveniently using various Matchers
// Constructor matchers start with c, field matchers start with f, method matchers start with m
...
public final class Example {
    ...
    public static class TestClass {
        ...
        private TestClass(String field) { this.field = field; }
        private String someMethod(String a) { return this.field + " " + a; }
    }
    ...
    public static void main(String[] args) {
        ...
        SparrowField field = sClass.getDeclaredSparrowField(fType(String.class), 0); 
